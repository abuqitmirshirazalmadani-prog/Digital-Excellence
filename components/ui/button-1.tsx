...
const GradientButton = ({
  ...
  return (
    <div className="text-[#eee] text-center w-full sm:w-auto">
      <div
        role="button"
        ...
        {...props}
      >
        <span className="relative z-10 text-[var(--color-text)] flex items-center justify-center gap-2 font-bold tracking-tight">
          {children}
        </span>
      </div>
    </div>
