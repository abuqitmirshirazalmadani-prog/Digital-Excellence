...
const Word: React.FC<WordProps> = ({ children, progress, range, className }) => {
  ...
  return (
    <span className={cn("relative mt-[12px] mr-1 font-semibold", className)}>
...
export const MagicText: React.FC<MagicTextProps> = ({ text, className = "", wordClassName = "text-base md:text-xl" }) => {
